<div class="side-menu sidebar-inverse">
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div>
            <?php echo menu('admin', 'vendor.voyager.menu.admin_menu'); ?>

        </div>
    </nav>
</div>
<?php /**PATH C:\wamp64\www\new laravel project\himachalcabrentals.com\resources\views/vendor/voyager/dashboard/sidebar.blade.php ENDPATH**/ ?>